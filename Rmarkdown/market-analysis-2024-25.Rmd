...
The primary element to consider when trying to understand Portuguese society is population. Data from the past 200 years shows an exponential demographic increase in the 20th century. This can be explained by a series of factors, namely a general betterment of living conditions in Europe following the industrial revolutions, with the gradual diffusion of better economic, social, political, educational and sanitary conditions in the modern world. Also important to mention is the period of general peace that followed the Second World War, as contexts offering stability and security favour demographic growth. Such a trend is mirrored by population density, analysing this statistic in the same time span, a common fluctuating trend prevails. In the second half of the 1960s though, a change in tendency is visible, and can be associated to a mass emigration following the rise of the Estado Novo dictatorship. 

Another demographic value to take into account is life expectancy, and it is noticeable that it dramatically increases following the end of the Second World War, as to be expected, suffering small dips as part of a fluctuating growth. 

In addition, a focus on immigration was provided to put into perspective the magnitude of foreigner influx into the nation. Regarding this latter point, a variation in trend occurs in concomitance with the 2008 global financial crisis, and can be explained by an adoption of more restrictive immigration policies in Portugal. 
...
The graph suggests a consistent upward linear trend in life expectancy and can be divided into three main sections. The first section (1940 to 1950) is the most unstable one, the life expectancy dropping from 52 to 47 years, in 1943, before rising again until 56 years. The second section (1950 to 1970) presents some fluctuations but overall, an upward movement, indicating slow increases despite minor volatility. The third and last section (1970 to present days) is characterized by a steady linear growth without any significant fluctuation.

During the 20th century a large number of regulations have been implemented to improve the health system and reduce mortality. Key initiatives include investments made in the health infrastructures to enhance care quality, an efficient vaccination program to control infection diseases, the access to health services is guaranteed to everyone, but also international collaborations have helped these improvements. Generally speaking, these efforts have contributed to the overall rise of the life expectancy trend.
...
parallels_population <-
  ...
  filter(Year >= 1950 & Entity %in% radioBn_choice & Year <= 2023) %>%
  select(-Code) %>%
...
filler
```{r}
economic_factor_choice <- c("Real GDP", "Real GDP Growth Rate", "Unemployment Rate", "Inflation Rate")
