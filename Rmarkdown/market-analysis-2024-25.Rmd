...
Such a trend is mirrored by population density, analysing this statistic in the same time span, a common fluctuating trend prevails. In the second half of the 1960s though, a change in tendency is visible, and can be associated to a mass emigration following the rise of the Estado Novo dictatorship. 
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-#
#UI AND SERVER LOGIC
health_graph_choice <- c('Life Expectancy', 'Daily Calorie Intake', 'Obesity Rate')
health_graph_code <- list(clean_life_expectancy, clean_calorie_intake, clean_obesity_rate)
