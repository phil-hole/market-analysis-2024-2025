    ...
    sidebarLayout(
      sidebarPanel(
        ...
        sliderInput(inputId = "economics_year_slider",
                    ...
                    dragRange = TRUE#,
                    # animate = list(
                    #   interval = 2000,         # Milliseconds between steps
                    #   loop = FALSE,            # Whether the animation loops back to start
                    #   playButton = "<br>▶",  # Custom text for the play button
                    #   pauseButton = "<br>⏸ " # Custom text for the pause button
                    # )
                   )
      ),
